    ...
    <div class="container">
      <div style="float: right">
        ...
        <button type="button" class="btn btn-danger">
          <a href="_actions/logout.php" class="text-decoration-none text-light"
            >Logout</a
          >
        </button>
      </div>
        ...
        <tr>
          ...
          <td>
            ...
            <div class="btn-group dropdown">
              ...
              <a
                href="_actions/unsuspend.php?id=<?=$user->id?>"
                class="btn btn-sm btn-danger"
                >Suspended</a
              >
              <?php else: ?>
              <a
                href="_actions/suspend.php?id=<?=$user->id?>"
              ...
              <a
                href="_actions/delete.php?id=<?=$user->id?>"
